...
class Ghost():
    ...
    #
    #     closest_node = min(decision_nodes, key=lambda node: self.calculate_distance(node, pacman))
    #
    #     while queue:
    ...
    #         if current_node == closest_node.center:
    #             break
    #
    ...
    #     if self.ghost_bb.center == closest_node.center:
    #         for neighbor in decision_nodes:
    #             if self.ghost_bb.center != neighbor.center:
